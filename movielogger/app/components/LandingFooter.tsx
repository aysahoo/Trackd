...
export default function LandingFooter({ isDark, toggleTheme }: LandingFooterProps) {
  ...
  useEffect(() => {
    fetch("https://api.github.com/repos/aysahoo/Trackd")
      .then((res) => res.json())
      .then((data) => {
    ...
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col items-center mt-8 sm:mt-12">
          ...
          />
          <div className="flex flex-col-reverse sm:flex-row items-center justify-between w-full mt-4 sm:mt-5 gap-4 sm:gap-0">
            ...
            <div className="flex items-center gap-3">
              {/* GitHub Star Button */}
              <button
                onClick={() => window.open("https://github.com/aysahoo/Trackd", "_blank")}
