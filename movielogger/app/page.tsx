      ...
      <main className="flex-1">
        ...
        <section className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 md:py-12 lg:py-16">
          <div className="text-center">
            {/* Headline */}
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-6xl xl:text-7xl font-semibold tracking-tight text-zinc-900 mb-6 sm:mb-8 break-words">
              Document Your Movie Journey.
            </h1>

            {/* Subheadline */}
            <p className="text-lg sm:text-xl md:text-2xl font-semibold text-zinc-500 mb-6 sm:mb-8 max-w-2xl mx-auto px-2">
